...
import com.ruffian7.sevenclicker.gui.RangeSlider;
...
public class ClickerGui {
    ...
    private void setupFrame() {
        ...
        Toolkit.getDefaultToolkit().addAWTEventListener(new AWTEventListener(){
            ...
            public void eventDispatched(AWTEvent event) {
                if (event.getID() == 500 && !(((MouseEvent)event).getSource() instanceof JTextField)) {
        ...
        this.dropdown.addMouseListener(new MouseAdapter(){
            ...
            public void mousePressed(MouseEvent e) {
                if (ClickerGui.this.frame.getHeight() == 125) {
                    ...
                    frameTimeline.play();
                    KeyboardFocusManager.getCurrentKeyboardFocusManager().clearGlobalFocusOwner();
                } else if (ClickerGui.this.frame.getHeight() == 225) {
    ...
    private void setupSettings() {
        ...
        this.toggleKeyField.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent e) {
                try {
                    if (!KeyEvent.getKeyModifiersText(e.getModifiers()).contains(KeyEvent.getKeyText(e.getKeyCode())) && e.getKeyCode() != 20) {
    ...
    private String getKeyString(int keyCode, int modifiers) {
        ...
        if (keyCode == 0) {
            ...
            keyString = keyCode == 32 ? "Space" : KeyEvent.getKeyText(keyCode);
        }
